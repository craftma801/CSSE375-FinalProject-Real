...
//            throw new ActionFailedException("Failed to take knowledge!");
    ...
    private boolean givePlayerOptionToPlayEventCard(Player currentPlayer) {
        ...
        String handOverflowingAction = gameWindow.promptSelectOption(new PromptWindowInputs(possibleActions,
        ...
        String eventCardNameToPlay = gameWindow.promptSelectOption(new PromptWindowInputs(cardsToSelectFrom.toArray(new String[0]),
