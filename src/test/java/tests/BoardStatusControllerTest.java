...
public class BoardStatusControllerTest {
    ...
    private final City chicago = new City("Chicago", 0, 0, CityColor.BLUE);
    private final City atlanta = new City("Atlanta", 0, 0, CityColor.BLUE);
    private final City london = new City("London", 0, 0, CityColor.BLUE);
    private final City newYork = new City("New York", 0, 0, CityColor.BLUE);
    private final City sanFrancisco = new City("San Francisco", 0, 0, CityColor.BLUE);
    private final City montreal = new City("Montreal", 0, 0, CityColor.BLUE);
    private final City washington = new City("Washington", 0, 0, CityColor.BLUE);
    private final City miami = new City("Miami", 0, 0, CityColor.YELLOW);
    private BoardStatusController bsc;
    private GameWindowInterface gw;
    ...
    private BoardStatusController createTestBoard(GameWindowInterface gw) {
    ...
    private void connect(City from, City... toCities) {
    ...
    private CompletableFuture<City> generateTestFuture(City city) {
